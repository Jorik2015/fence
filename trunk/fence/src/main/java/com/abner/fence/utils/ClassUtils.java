...
public final class ClassUtils {
	private final static String[] types = new String[] { "java.lang.Boolean", "java.lang.Character", "java.lang.Byte",
	 ...
	 * 
	 * @param loader
	 *            the <code>ClassLoader</code> whose associated cache should be cleared
	 */
	...
	public static <T extends Annotation> T lookupAnno(Class<?> clazz, String methodName, Class<T> annoClazz,
			Class<?>... params) {
	 ...
	 * 
	 * <p>
	 * This will check the cache associated with the specified <code>ClassLoader</code>. If there is no cache hit, then
	 * a new <code>MetaData</code> instance will be created and stored.
	 * 
	 * @param loader
	...
	private static final class MetaData {
		 ...
		 * 
		 * @param params
		 *            the parameters to a <code>Constructor</code> or a <code>Method</code> instance
