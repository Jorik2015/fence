...
public class Field extends com.abner.fence.component.ExtInput {
	...
	public void setInputType ( String   inputType ) {
    	...
    	/*
	 *The error text to use when marking a
	...
	public void setInvalidText ( String   invalidText ) {
    	...
    	/*
	 *True to disable the field (defaults to
          false). 
          Be aware that conformant with the 
          HTML
          specification, disabled Fields will not be 
          submitted.
	 */
	...
	public void setSubmitValue ( Boolean   submitValue ) {
    	...
    	/*
	 *The event that should initiate field
...
'off'}
	 ...
	 *
          ...
          Note: this only sets the element's readOnly DOM
          attribute. Setting 
          readOnly=true, for example, will not disable
	 ...
	 *The tabIndex for this field. Note this
          ...
          are built via applyTo (defaults to undefined).
	 */
	 ...
	 *The field's HTML name attribute
          (defaults to ''). 
          Note: this property must be set if this field is
