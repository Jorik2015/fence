...
/**
 * Defines the interface and base operation
  ...
  elements can be associated with a DragDrop instance: 
    ...
    linked element: the element that is passed into the
    constructor. This is the element which defines the boundaries
    for interaction with other DragDrop objects.
    handle element(s): The drag operation only occurs if the
...
dd = new Ext.dd.DragDrop("div1", "group1");
  Since none of the event handlers have been implemented,
