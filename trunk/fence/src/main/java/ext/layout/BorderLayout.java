...
/**
 * 
    This is a multi-pane, application-oriented UI layout style
    ...
    keyword.
    BorderLayout does not have any direct config options (other
...
cmargins: 
'5 5 0 5', 
// adjust top margin when collapsed
...
'5 5 0 0'
    ...
    :
        ...
        Any container using the BorderLayout 
        must have a child item with 
        region:'center'. The child item in the center
        ...
        west or 
        east must have 
        width defined (an integer representing the number
        of pixels that the region should take up).
        Any child items with a region of 
        north or 
        south must have 
        height defined.
        The regions of a BorderLayout are 
        fixed at render time and thereafter, its child
