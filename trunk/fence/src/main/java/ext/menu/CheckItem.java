...
/**
 * Adds a menu item that contains a
  checkbox by default, but can also be part of a radio group.
 */
@XType("menucheckitem")
...
public class CheckItem extends Item {
	...
	public String getFamily() {
		...
		/*
	 *All check items with the same group
	...
	public void setGroupClass ( String   groupClass ) {
    	...
    	/*
	 *True to initialize this checkbox as
          checked (defaults to false). Note that if this checkbox
          is part of a radio group (group = true) only the last
          item in the group that is initialized with checked = true
          will be rendered as checked.
	 */
