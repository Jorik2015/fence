...
import ext.util.MessageFactory;
import ext.util.StringUtil;
import ext.util.TypedCollections;
...
public class ExtInput extends BoxComponent implements EditableValueHolder {
	 ...
	 * {@link javax.faces.application.FacesMessage} to be created if a
	 * conversion error occurs, and neither the page author nor the
	 * {@link ConverterException} provides a message.
	 * </p>
	 */
	public static final String CONVERSION_MESSAGE_ID = "com.abner.fence.ExtInput.CONVERSION";

	/**
	 * <p>
	 * The message identifier of the
	 * {@link javax.faces.application.FacesMessage} to be created if a required
	 * check fails.
	 * </p>
	 */
	public static final String REQUIRED_MESSAGE_ID = "JSF_VALIDATE_REQUIRED";

	/**
	 * <p>
	 * The message identifier of the
	 * {@link javax.faces.application.FacesMessage} to be created if a model
	 * update error occurs, and the thrown exception has no message.
	 * </p>
	 */
	public static final String UPDATE_MESSAGE_ID = "com.abner.fence.ExtInput.UPDATE";
	...
	private static final Logger LOGGER = Logger.getLogger(
			"javax.faces.component", "javax.faces.LogStrings");
	...
	/**
	 * <p>
	 * Return the submittedValue value of this {@link UIInput} component. This
	...
	/**
	 * <p>
	 * Set the submittedValue value of this {@link UIInput} component. This
	 * method should only be used by the <code>decode()</code> and
	 * <code>validate()</code> method of this component, or its corresponding
	 * {@link Renderer}.
	 * </p>
	...
	public void setValue(Object value) {
		...
		this.handleConfig("value", value);// FIXED
	}
	 ...
	 * <code>ValueBinding</code> associated with it for the "value" property,
	 * this binding is evaluated when {@link UIOutput#getValue} is called.
	 * Otherwise, <code>null</code> is returned from <code>getValue()</code>.
	 * </p>
	 */
	...
	/**
	 * <p>
	 * If there has been a call to {@link #setRequiredMessage} on this instance,
	 * return the message. Otherwise, call {@link #getValueExpression} passing
	 * the key "requiredMessage", get the result of the expression, and return
	 * it. Any {@link ELException}s thrown during the call to
	 * <code>getValue()</code> must be wrapped in a {@link FacesException} and
	 * rethrown.
	 */
	...
	/**
	 * <p>
	 * Override any {@link ValueExpression} set for the "requiredMessage" with
	 * the literal argument provided to this method. Subsequent calls to
	 * {@link #getRequiredMessage} will return this value;
	 * </p>
	 * 
	 * @param message
	 *            the literal message value to be displayed in the event the
	 *            user hasn't supplied a value and one is required.
	 */
	 ...
	 * passing the key "converterMessage", get the result of the expression, and
	 * return it. Any {@link ELException}s thrown during the call to
	 * <code>getValue()</code> must be wrapped in a {@link FacesException} and
	 * rethrown.
	 */
	...
	/**
	 * <p>
	 * Override any {@link ValueExpression} set for the "converterMessage" with
	 * the literal argument provided to this method. Subsequent calls to
	 * {@link #getConverterMessage} will return this value;
	 * </p>
	 * 
	 * @param message
	 *            the literal message value to be displayed in the event
	 *            conversion fails.
	 */
	 ...
	 * instance, return the message. Otherwise, call {@link #getValueExpression}
	 * passing the key "validatorMessage", get the result of the expression, and
	 * return it. Any {@link ELException}s thrown during the call to
	 * <code>getValue()</code> must be wrapped in a {@link FacesException} and
	 * rethrown.
	 */
	...
	/**
	 * <p>
	 * Override any {@link ValueExpression} set for the "validatorMessage" with
	 * the literal argument provided to this method. Subsequent calls to
	...
	/**
	 * <p>
	 * Set a <code>MethodBinding</code> pointing at a method that will be called
	 * during <em>Process Validations</em> phase of the request processing
	 * lifecycle, to validate the current value of this component.
	 * </p>
	 * <p/>
	 * <p>
	 ...
	 * @deprecated Use {@link #addValidator} instead, obtaining the argument
	 *             {@link Validator} by creating an instance of
	 *             {@link javax.faces.validator.MethodExpressionValidator}.
	 */
		...
		if (null != curValidators) {
			for (int i = 0; i < curValidators.length; i++) {
				...
				if (null == validatorBinding) {
					...
					// list.
					if (MethodBindingValidator.class == curValidators[i]
							.getClass()) {
	...
	public MethodBinding getValueChangeListener() {
		...
		if (null != curListeners) {
			for (int i = 0; i < curListeners.length; i++) {
				...
				if (MethodBindingValueChangeListener.class == curListeners[i]
						.getClass()) {
	 ...
	 *             argument {@link ValueChangeListener} by creating an instance
	 *             of
	...
	public void setValueChangeListener(MethodBinding valueChangeListener) {
		...
		addValueChangeListener(new MethodBindingValueChangeListener(
				valueChangeListener));
	}
	 ...
	 * from {@link UIComponentBase}, calls <code>validate()</code> if the the
	 ...
	 * inherited from {@link UIComponentBase}, calls <code>validate()</code> if
	 * the <code>immediate</code> property is false (which is the default); if
	 * the component is invalid afterwards, calls
	 * {@link FacesContext#renderResponse}. If a <code>RuntimeException</code>
	 ...
	 * inherited from {@link UIComponentBase}, calls <code>updateModel()</code>.
	...
	public void updateModel(FacesContext context) {
		...
		if (ve == null && renderer != null) {
			ve = getFormValueExpression(context);
		}
				...
				if (null == messageStr) {
					message = MessageFactory.getMessage(context,
							UPDATE_MESSAGE_ID, MessageFactory.getLabel(context,
									this));
					message = new ExtFacesMessage(message, clientId);
				} else {
					message = new ExtFacesMessage(FacesMessage.SEVERITY_ERROR,
							clientId, messageStr, messageStr);
				}
	 ...
	 * <li>If no <code>Renderer</code> is present, and the submitted value is a
	 * String, locate a {@link Converter} as follows:
	 * <ul>
	 ...
	 * <code>true</code>, and the <code>required</code> property is also true,
	 ...
	 * and <code>detail</code> in the {@link FacesMessage} that is enqueued on
	 * the <code>FacesContext</code>, otherwise use the message for the
	 * {@link #REQUIRED_MESSAGE_ID}.</li>
	 * <li>Set the <code>valid</code> property on this component to
	 * <code>false</code>.</li>
	 * </ul>
	 * </li>
	 ...
	 * this {@link UIInput}, followed by the method pointed at by the
	...
	protected void validateValue(FacesContext context, Object newValue) {
		...
		if (isValid() && isRequired() && isEmpty(newValue)) {
			...
			if (null != requiredMessageStr) {
				message = new ExtFacesMessage(FacesMessage.SEVERITY_ERROR,
						clientId, requiredMessageStr, requiredMessageStr);
			} else {
				message = MessageFactory.getMessage(context,
						REQUIRED_MESSAGE_ID, MessageFactory.getLabel(context,
								this));
				message = new ExtFacesMessage(message, clientId);
			}
			context.addMessage(getClientId(context), message);
	...
	/**
	 * <p>
	 * Add a {@link Validator} instance to the set associated with this
	 * {@link UIInput}.
	 * </p>
	 * 
	 * @param validator
	...
	/**
	 * <p>
	 * Return the set of registered {@link Validator}s for this {@link UIInput}
	...
	/**
	 * <p>
	 * Remove a {@link Validator} instance from the set associated with this
	 * {@link UIInput}, if it was previously associated. Otherwise, do nothing.
	 * </p>
	 * 
	 * @param validator
	 ...
	 * {@link UIInput} instance. If there are no registered listeners, a
	...
	public void restoreState(FacesContext context, Object state) {
		...
		if (null != (restoredValidators = TypedCollections.dynamicallyCastList(
				(List<?>) restoreAttachedState(context, values[8]),
				Validator.class))) {
	...
	public ValueExpression getFormValueExpression(FacesContext context) {
		...
		FormPanel form = ComponentUtil.inNested(FormPanel.class, field);
		...
		if (!StringUtil.isEmpty(model) && !StringUtil.isEmpty(name)) {
	...
	private void addConversionErrorMessage(FacesContext context,
		...
		if (null != converterMessageString) {
			message = new ExtFacesMessage(FacesMessage.SEVERITY_ERROR,
					clientId, converterMessageString, converterMessageString);
		} else {
