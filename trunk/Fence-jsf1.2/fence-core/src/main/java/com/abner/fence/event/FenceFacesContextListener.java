 ...
 * 
 *         <p>
 *         This listener, declared in the TLD for jsf-extensions-avatar, is
 *         responsible for parsing the value of the
 *         <code>com.sun.faces.extensions.avatar.FacesEvents</code>
 *         <code>&lt;init-param&gt;</code> per the algorithm described in
 *         {@link #contextInitialized}.
 *         </p>
 * 
 */

public class FenceFacesContextListener implements ServletContextListener {

	/**
	 * <p>
	 * Parse the
	 * {@link com.sun.faces.extensions.avatar.lifecycle.AsyncResponse#FACES_EVENT_CONTEXT_PARAM}
	 * context param and populate the application scoped Map under the same key
	 * with according to the following syntax:
	 * </p>
	 * 
	 * <code><pre>
&lt;facesevent-header-value&gt; ::= &lt;facesevent-info&gt;[,&lt;facesevent-info&gt;...]
  ...
  &lt;fqcn&gt; :: Java Language Fully Qualified Class Name
	 ...
	 * 
	 * <p>
	 * Pairings for the jsf api are pre-populated in this map
	 * </p>
	 */
	...
	public void contextInitialized(ServletContextEvent evt) {
		...
		int len, i = 0, j = 0;
		String eventsParam = evt.getServletContext().getInitParameter(RequestUtils.FACES_EVENT_CONTEXT_PARAM);
		if (null == eventsParam) {
			eventsParam = "";
		}
		eventsParam = eventsParam
				+ ",ValueChangeEvent:javax.faces.event.ValueChangeEvent:"
		...
		for (i = 0; i < facesEvents.length; i++) {
			...
			// PENDING() I18N
			String message = "Can't get class for event type "	+ eventCtorInfo[0] + ".";
			...
			try {
				...
				eventMap.put(eventId, new ConstructorWrapper(Class.forName(
						eventClass).getConstructor(eventCtorClasses),
						eventCtorClasses));
