...
/**
 * 
    This layout manages multiple child Components, each fitted
    ...
    keyword.
    The CardLayout's focal method is 
    setActiveItem. Since only
    ...
    In the following example, a simplistic wizard setup is
    ...
    functionality needed. Example usage:
...
'card-0',
        html: 
'<h1>Welcome to the Wizard!</h1><p>Step 1 of
3</p>'
    },{
        id: 
'card-1',
...
'card-2',
        html: 
'<h1>Congratulations!</h1><p>Step 3 of 3 -
Complete</p>'
    }]
});
