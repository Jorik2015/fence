...
<div class="long">The path to an icon for the node. The
	...
	public void setQtipCfg ( String   qtipCfg ) {
    	...
    	/*
	 *<?xml version="1.0" encoding="UTF-8" standalone="no"?>
<div class="long">True to render a checked checkbox for
          this node, false to render an unchecked checkbox
          (defaults to undefined with no checkbox rendered)</div>
