...
<div class="description">
    <p>This is a region of a 
    <a ext:cls="Ext.layout.BorderLayout" href="output/Ext.layout.BorderLayout.html">BorderLayout</a> that acts as
    a subcontainer within the layout. Each region has its own 
    <a ext:cls="Ext.layout.ContainerLayout" href="output/Ext.layout.ContainerLayout.html">layout</a> that is
    independent of other regions and the containing BorderLayout,
    and can be any of the 
    <a ext:cls="Ext.layout.ContainerLayout" href="output/Ext.layout.ContainerLayout.html">valid Ext layout
    types</a>.</p>
    <p>Region size is managed automatically and cannot be changed
    by the user -- for 
    <a ext:cls="Ext.layout.BorderLayout.Region" ext:member="split" href="output/Ext.layout.BorderLayout.Region.html#Ext.layout.BorderLayout.Region-split">resizable regions</a>,
    see 
    <a ext:cls="Ext.layout.BorderLayout.SplitRegion" href="output/Ext.layout.BorderLayout.SplitRegion.html">Ext.layout.BorderLayout.SplitRegion</a>.</p>
  </div>
