...
<div class="description">
    <p>This is a layout that inherits the anchoring of 
    <b>
      <a ext:cls="Ext.layout.AnchorLayout" href="output/Ext.layout.AnchorLayout.html">Ext.layout.AnchorLayout</a>
    </b> and adds the ability for x/y positioning using the
...
<em>'to'</em>,
        anchor:
<em>'100%'</em>  
<i>// anchor width by percentage</i>
    },{
        x: 0,
        y: 35,
        xtype:
...
@FacesComponent(value = "Ext.layout.AbsoluteLayout")
public class AbsoluteLayout extends AnchorLayout {
	public static final String COMPONENT_FAMILY = "Ext.layout.AbsoluteLayout";

	/**
	 * <p>
	 * Create a new {@link Ext.layout.AbsoluteLayout} instance with default property values.
	 * </p>
	 */
