...
<div class="description">A type of axis that displays items in
  categories.</div>
...
@FacesComponent(value = "Ext.chart.CategoryAxis")
public class CategoryAxis extends Axis {
	public static final String COMPONENT_FAMILY = "Ext.chart.CategoryAxis";

	/**
	 * <p>
	 * Create a new {@link Ext.chart.CategoryAxis} instance with default property values.
	 * </p>
	 */
	public CategoryAxis() {
		super();
