...
@FacesComponent(value = "Ext.grid.PivotGrid")
...
<div class="long">Either and array of 
	...
	public Object getTopAxis () {
		return (Object) getStateHelper().eval(PropertyKeys.topAxis);
	}
	...
	public void setTopAxis ( Object   topAxis ) {
		getStateHelper().put(PropertyKeys.topAxis, topAxis);
		handleAttribute("topAxis", topAxis);
	}
    	/*
	 *<?xml version="1.0" encoding="UTF-8" standalone="no"?>
<div class="long">Either and array of 
	...
	public Object getLeftAxis () {
		return (Object) getStateHelper().eval(PropertyKeys.leftAxis);
	}
	...
	public void setLeftAxis ( Object   leftAxis ) {
		getStateHelper().put(PropertyKeys.leftAxis, leftAxis);
		handleAttribute("leftAxis", leftAxis);
	}
    	/*
	 *<?xml version="1.0" encoding="UTF-8" standalone="no"?>
<div class="long">The aggregation function to use to
	...
	public String getAggregator () {
		return (String) getStateHelper().eval(PropertyKeys.aggregator);
	}
	...
	public void setAggregator ( String   aggregator ) {
		getStateHelper().put(PropertyKeys.aggregator, aggregator);
		handleAttribute("aggregator", aggregator);
	}
    	/*
	 *
	...
	public String getMeasure () {
		return (String) getStateHelper().eval(PropertyKeys.measure);
	}
	...
	public void setMeasure ( String   measure ) {
		getStateHelper().put(PropertyKeys.measure, measure);
		handleAttribute("measure", measure);
	}
    	/*
	 *<?xml version="1.0" encoding="UTF-8" standalone="no"?>
