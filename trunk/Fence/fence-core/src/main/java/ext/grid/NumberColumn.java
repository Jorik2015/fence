...
<div class="description">
    ...
    according to a 
    <a ext:cls="Ext.grid.NumberColumn" ext:member="format" href="output/Ext.grid.NumberColumn.html#Ext.grid.NumberColumn-format">format</a>
    string. See the 
...
@FacesComponent(value = "Ext.grid.NumberColumn")
public class NumberColumn extends Column {
	public static final String COMPONENT_FAMILY = "Ext.grid.NumberColumn";

	/**
	 * <p>
	 * Create a new {@link Ext.grid.NumberColumn} instance with default property values.
	 * </p>
	 */
	public NumberColumn() {
		super();
