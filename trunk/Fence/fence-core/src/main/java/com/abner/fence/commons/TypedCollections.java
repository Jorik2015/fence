...
public final class TypedCollections {
	 ...
	 */
	public static <E, TypedC extends Collection<E>> TypedC dynamicallyCastCollection(Collection<?> c, Class<E> type,
	...
	public static <E> List<E> dynamicallyCastList(List<?> list, Class<E> type) {
		return (List<E>) dynamicallyCastCollection(list, type, List.class);
	}
	...
	public static <E> Set<E> dynamicallyCastSet(Set<?> set, Class<E> type) {
		return (Set<E>) dynamicallyCastCollection(set, type, Set.class);
	}
