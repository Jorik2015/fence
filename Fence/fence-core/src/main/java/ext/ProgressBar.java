...
<div class="description">
    <p>An updateable progress bar component. The progress bar
    supports two different modes: manual and automatic.</p>
    <p>In manual mode, you are responsible for showing, updating
    (via 
    <a ext:cls="Ext.ProgressBar" ext:member="updateProgress" href="output/Ext.ProgressBar.html#Ext.ProgressBar-updateProgress">updateProgress</a>) and clearing the
    ...
    can update the control.</p>
    <p>In automatic mode, you simply call 
    <a ext:cls="Ext.ProgressBar" ext:member="wait" href="output/Ext.ProgressBar.html#Ext.ProgressBar-wait">wait</a> and let
    ...
    indicating intermediate progress.</p>
  </div>
