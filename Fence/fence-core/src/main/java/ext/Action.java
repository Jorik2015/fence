...
<div class="description">
  ...
  <a ext:cls="Ext.Button" href="output/Ext.Button.html">Ext.Button</a> and 
  <a ext:cls="Ext.menu.Menu" href="output/Ext.menu.Menu.html">Ext.menu.Menu</a> components).</p>
  <p>Aside from supporting the config object interface, any
  ...
  setHandler(function).</p>Example usage:
  <br/>
<pre>
<code>
...
icon image:</i>
.
<b>do</b>-something { background-image: url(../images/my-icon.gif)
0 6px no-repeat !important; }</code>
          </pre>
</div>
	...
	public void setDisabled ( Boolean   disabled ) {
    	...
    	/*
	 *<?xml version="1.0" encoding="UTF-8" standalone="no"?>
<div class="long">The function that will be invoked by
          each component tied to this action when the component's
          primary event is triggered (defaults to undefined).</div>
