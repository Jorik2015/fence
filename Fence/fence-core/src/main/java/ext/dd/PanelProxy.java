...
<div class="description">A custom drag proxy implementation
  specific to 
  <a ext:cls="Ext.Panel" href="output/Ext.Panel.html">Ext.Panel</a>s. This class is primarily used
  internally for the Panel's drag drop implementation, and should
  never need to be created directly.</div>
