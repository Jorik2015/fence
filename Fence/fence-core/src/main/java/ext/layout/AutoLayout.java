...
<div class="description">
    <p>The AutoLayout is the default layout manager delegated by 
    <a ext:cls="Ext.Container" href="output/Ext.Container.html">Ext.Container</a> to render any child
    Components when no 
    <tt>
      <a ext:cls="Ext.Container" ext:member="layout" href="output/Ext.Container.html#Ext.Container-layout">layout</a>
    </tt> is configured into a 
    <a ext:cls="Ext.Container" href="output/Ext.Container.html">Container</a>.. AutoLayout provides
...
@InstanceOf("Ext.layout.AutoLayout")
@ParseConfigMode(ui = false,name="layoutConfig",pmode=PersistenceMode.ParentProperty,rmode=ReferenceMode.Config)
@FacesComponent(value = "Ext.layout.AutoLayout")
public class AutoLayout extends ExtComponent {
	public static final String COMPONENT_FAMILY = "Ext.layout.AutoLayout";

	/**
	 * <p>
	 * Create a new {@link Ext.layout.AutoLayout} instance with default property values.
	 * </p>
	 */
	public AutoLayout() {
		super();
