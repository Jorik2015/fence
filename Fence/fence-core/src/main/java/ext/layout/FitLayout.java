...
<div class="description">
    <p>This is a base class for layouts that contain 
    <b>a single item</b> that automatically expands to fill the
    ...
    keyword.</p>
    <p>FitLayout does not have any direct config options (other
    ...
    the first one will be displayed. Example usage:</p>
<pre>
<code>
<b>var</b> p = 
<b>new</b> Ext.Panel({
...
<em>'Inner Panel'</em>,
        html: 
<em>'&lt;p&gt;This is the inner panel content&lt;/p&gt;'</em>,
        border: false
    }
});</code>
    </pre>
