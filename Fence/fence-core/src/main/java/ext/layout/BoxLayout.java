...
<div class="description">
    <p>Base Class for HBoxLayout and VBoxLayout Classes. Generally
    it should not need to be used directly.</p>
  </div>
...
@FacesComponent(value = "Ext.layout.BoxLayout")
public class BoxLayout extends ContainerLayout {
	public static final String COMPONENT_FAMILY = "Ext.layout.BoxLayout";

	/**
	 * <p>
	 * Create a new {@link Ext.layout.BoxLayout} instance with default property values.
	 * </p>
	 */
	public BoxLayout() {
		super();
