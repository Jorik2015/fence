...
<div class="description">Layout manager used by Ext.Toolbar. This
  is highly specialised for use by Toolbars and would not usually
  be used by any other class.</div>
...
@FacesComponent(value = "Ext.layout.ToolbarLayout")
public class ToolbarLayout extends ContainerLayout {
	public static final String COMPONENT_FAMILY = "Ext.layout.ToolbarLayout";

	/**
	 * <p>
	 * Create a new {@link Ext.layout.ToolbarLayout} instance with default property values.
	 * </p>
	 */
