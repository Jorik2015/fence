...
<div class="long">A named drag drop group to which this
	...
	public void setAppendOnly ( String   appendOnly ) {
    	...
    	/*
	 *<?xml version="1.0" encoding="UTF-8" standalone="no"?>
<div class="long">Allow inserting a dragged node between
	...
	public void setAllowParentInsert ( Boolean   allowParentInsert ) {
    	...
    	/*
	 *<?xml version="1.0" encoding="UTF-8" standalone="no"?>
<div class="long">The delay in milliseconds to wait
          before expanding a target tree node while dragging a
          droppable node over the target (defaults to 1000)</div>
