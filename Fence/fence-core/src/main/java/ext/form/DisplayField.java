...
<div class="description">A display-only text field which is not
  validated and not submitted.</div>
...
public class DisplayField extends Field {
	 ...
	 *<?xml version="1.0" encoding="UTF-8" standalone="no"?>
<div class="long">
          <tt>false</tt> to skip HTML-encoding the text when
          rendering it (defaults to 
          <tt>false</tt>). This might be useful if you want to
