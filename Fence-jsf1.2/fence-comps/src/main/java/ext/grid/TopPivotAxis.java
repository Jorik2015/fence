...
@ParseConfigMode(ui = false, name = "topAxis", pmode = PersistenceMode.ParentProperty, rmode = ReferenceMode.Var)
public class TopPivotAxis extends Component {
	public static final String COMPONENT_FAMILY = "Ext.grid.TopPivotAxis";

	/**
	 * <p>
	 * Create a new {@link Ext.grid.LeftPivotAxis} instance with default property values.
	 * </p>
	 */
	public TopPivotAxis() {
		super();
