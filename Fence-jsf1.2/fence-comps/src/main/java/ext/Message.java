...
public class Message extends Window {
	...
	/**
	 * <p>
	 * Return the flag indicating whether only global messages (that is,
	...
	/**
	 * <p>
	 * Set the flag indicating whether only global messages (that is, messages
	 * with no associated client identifier) should be rendered.
	 * </p>
	 * 
	 * @param globalOnly
	 *            The new flag value
	 ...
	 * the associated message(s) should be displayed. Defaults to
	 * <code>true</code>.
	 * </p>
	 */
	...
	/**
	 * <p>
	 * Set the flag indicating whether the <code>detail</code> property of the
	 * associated message(s) should be displayed.
	 * </p>
	 * 
	 * @param showDetail
	 *            The new flag
	...
	/**
	 * <p>
	 * Return the flag indicating whether the <code>summary</code> property of
	 * the associated message(s) should be displayed. Defaults to
	 * <code>false</code>.
	 * </p>
	 */
	public boolean isShowSummary() {
		...
		if (ve != null) {
			try {
				return (!Boolean.FALSE.equals(ve.getValue(getFacesContext()
						.getELContext())));
			} catch (ELException e) {
				throw new FacesException(e);
			}
	...
	/**
	 * <p>
	 * Set the flag indicating whether the <code>summary</code> property of the
	 * associated message(s) should be displayed.
	 * </p>
	 * 
	 * @param showSummary
