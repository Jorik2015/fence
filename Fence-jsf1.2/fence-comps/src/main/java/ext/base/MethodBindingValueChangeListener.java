...
public class MethodBindingValueChangeListener extends MethodBindingAdapterBase
	 ...
	 *             {@inheritDoc}
	 */
	public void processValueChange(ValueChangeEvent actionEvent)
			throws AbortProcessingException {
		...
		try {
			...
			Throwable cause = this.getExpectedCause(
					AbortProcessingException.class, ee);
