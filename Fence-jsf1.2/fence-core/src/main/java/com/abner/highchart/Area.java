...
public class Area {
	...
	public Area setAllowPointSelect(Boolean _allowPointSelect) {
	...
	public Area setAnimation(Boolean _animation) {
	...
	public Area setColor(String _color) {
		this.color_ = _color;
		return this;
	}
	...
	public Area setConnectNulls(Boolean _connectNulls) {
	...
	public Area setCropThreshold(Number _cropThreshold) {
	...
	public Area setCursor(String _cursor) {
	...
	public Area setDashStyle(String _dashStyle) {
	...
	public Area setDataLabels(DataLabels _dataLabels) {
	...
	public Area setEnableMouseTracking(Boolean _enableMouseTracking) {
	...
	public Area setEvents(Events _events) {
	...
	public Area setLineWidth(Number _lineWidth) {
	...
	public Area setMarker(Marker _marker) {
	...
	public Area setPoint(Point _point) {
		this.point_ = _point;
		return this;
	}
	...
	public Area setPointStart(Number _pointStart) {
	...
	public Area setPointInterval(Number _pointInterval) {
	...
	public Area setSelected(Boolean _selected) {
	...
	public Area setShadow(Boolean _shadow) {
	...
	public Area setShowCheckbox(Boolean _showCheckbox) {
	...
	public Area setShowInLegend(Boolean _showInLegend) {
	...
	public Area setStacking(String _stacking) {
	...
	public Area setStates(States _states) {
	...
	public Area setStickyTracking(Boolean _stickyTracking) {
	...
	public Area setTooltip(Object _tooltip) {
	...
	public Area setTurboThreshold(Number _turboThreshold) {
	...
	public Area setVisible(Boolean _visible) {
	...
	public Area setZIndex(Number _zIndex) {
	...
	public Area setFillColor(String _fillColor) {
	...
	public Area setFillOpacity(Number _fillOpacity) {
	...
	public Area setLineColor(String _lineColor) {
	...
	public Area setThreshold(Number _threshold) {
	...
	public Area setTrackByArea(Boolean _trackByArea) {
